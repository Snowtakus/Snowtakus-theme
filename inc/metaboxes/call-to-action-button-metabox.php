 ...
 *
 */
function snowtakus_call_to_action_button_meta_box_display() {
	global $post;
	...
	wp_nonce_field( 'snowtakus_cta_button_meta_box_nonce', 'snowtakus_cta_button_meta_box_nonce' );
	?>
 ...
 *
 */
function snowtakus_call_to_action_button_meta_box_save($post_id) {
	if (!isset($_POST['snowtakus_cta_button_meta_box_nonce'])
		|| !wp_verify_nonce($_POST['snowtakus_call_to_action_button_meta_box_nonce'], 'snowtakus_call_to_action_button_meta_box_nonce')) {
		return;
	}
...
add_action('save_post', 'snowtakus_call_to_action_button_meta_box_save');
