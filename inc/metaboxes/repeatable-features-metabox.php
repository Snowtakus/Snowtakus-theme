 ...
 *
 */
function snowtakus_repeatable_features_meta_box_display() {
	global $post;

	$repeatable_fields = get_post_meta($post->ID, 'repeatable_feature_fields', true);

	wp_nonce_field( 'snowtakus_repeatable_features_meta_box_nonce', 'snowtakus_repeatable_features_meta_box_nonce' );
	?>
 ...
 *
 */
function snowtakus_repeatable_features_meta_box_save($post_id) {
	if (!isset($_POST['snowtakus_repeatable_features_meta_box_nonce'])
		|| !wp_verify_nonce($_POST['snowtakus_repeatable_features_meta_box_nonce'], 'snowtakus_repeatable_features_meta_box_nonce')) {
		return;
	}
...
add_action('save_post', 'snowtakus_repeatable_features_meta_box_save');
