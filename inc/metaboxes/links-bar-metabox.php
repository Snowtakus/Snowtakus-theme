 ...
 *
 */
function snowtakus_links_bar_meta_box_display() {
	global $post;
  ...
  $link_bar_2_icon = get_post_meta($post->ID, 'link_bar_2_icon', true);
	...
	wp_nonce_field( 'snowtakus_links_bar_meta_box_nonce', 'snowtakus_links_bar_meta_box_nonce' );
	?>
 ...
 *
 */
function snowtakus_links_bar_meta_box_save($post_id) {
	if (!isset($_POST['snowtakus_links_bar_meta_box_nonce'])
		|| !wp_verify_nonce($_POST['snowtakus_links_bar_meta_box_nonce'], 'snowtakus_links_bar_meta_box_nonce')) {
		return;
	}
...
add_action('save_post', 'snowtakus_links_bar_meta_box_save');
