 ...
 */
function snowtakus_call_to_action_section_meta_box_display() {
	global $post;
	...
	wp_nonce_field( 'snowtakus_cta_section_meta_box_nonce', 'snowtakus_cta_section_meta_box_nonce' );

	$editor_text = get_post_meta( $post->ID, 'cta_section_wysiwyg', true );
	wp_editor( htmlspecialchars_decode( $editor_text ), 'snowtakus_cta_section_wysiwyg', $settings = array( 'textarea_name' => 'call-to-action-wysiwyg' ) );
  ?>
 ...
 */
function snowtakus_call_to_action_section_meta_box_save($post_id) {
	if (!isset($_POST['snowtakus_cta_section_meta_box_nonce'])
		|| !wp_verify_nonce($_POST['snowtakus_cta_section_meta_box_nonce'], 'snowtakus_cta_section_meta_box_nonce')) {
		return;
	}
...
add_action('save_post', 'snowtakus_call_to_action_section_meta_box_save');
