...
class Social_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'Social Widget', // Name
			array( 'description' => __( 'Social Media Links', 'snowtakus_text_domain' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		if ( isset( $instance[ 'facebook' ] ) ) {
			...
			$facebook = __( '', 'snowtakus_text_domain' );
		}
		if ( isset( $instance[ 'twitter' ] ) ) {
			$twitter = $instance[ 'twitter' ];
		}
		else {
			$twitter = __( '', 'snowtakus_text_domain' );
		}
		if ( isset( $instance[ 'insta' ] ) ) {
			$insta = $instance[ 'insta' ];
		}
		else {
			$insta = __( '', 'snowtakus_text_domain' );
		}
		?>
		<p>
