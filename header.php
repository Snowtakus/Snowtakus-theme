...
<div id="page" class="hfeed site">
  <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'snowtakus' ); ?></a>
    ...
    <div class="grid-container">
      <div class="grid-x grid-padding-x">
        ...
        <nav id="top-header-nav" class="site-navigation small-12 large-6 cell" role="navigation">
          <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><i class="fa fa-bars" aria-hidden="true"></i> <?php esc_html_e( 'Menu', 'snowtakus' ); ?></button>
